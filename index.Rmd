...
Let's try seeing how this group_by works by trying to get the average metric of a known genre like pop. You type out the values by hand and get the mean value as `r mean_pop_energy`
...
Your supervisor noticed what you were typing on your laptop and gave a tip to Google up on the function `summarize` to make the code more readable and safer. And it automatically ungroups the outermost group after giving the summary statistics. 
