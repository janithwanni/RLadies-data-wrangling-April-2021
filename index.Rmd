...
.center[<img src="images/data_wrangler.png" style="width:50%">]
.footnote[Illustration from Hadley Wickham’s 2019 talk, The Joy of Functional Programming ]
...
.center[<img src="images/dplyr_mutate.png" style="width:85%"/>]
]
...
We will first mutate the original dataset to check whether this works. 
...
.center[<img src="images/dplyr_filter_sm.png" style="width:70%"/>]
