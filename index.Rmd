...
output:
  xaringan::moon_reader:
    css: [default, kunoichi, metropolis-fonts,"index.css"]
    lib_dir: libs
    nature:
...
.pull-left[
<img src="images/profile_picture.jpg" style="
    height: auto;
    border-radius: 50%;
...
.center[<img src="https://github.com/thiyangt/DSjobtracker/raw/master/hexsticker/figures/hexsticker.png" style="width: 30%"> <img src="images/dplyr_hex.png" style="width: 30%">]

Runner's up in two datathons and finalist in two datathons.

<h2 style="color:#5b85aa">Where to find me?</h2>
...
<img src="images/numbers_mason_meme.jpg"/>
